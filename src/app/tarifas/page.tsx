...
export default function PaginaTarifas() {
  ...
  const tarifasMock = [
    ...
    },
    {
      ...
      descripcion: 'Entrega en 48 horas',
      precio: 'Q 15.00',
    ...
    },
    {
      ...
      descripcion: 'Entrega internacional rápida',
      precio: 'Q 150.00',
    ...
    {
      id: '4',
      servicio: 'Estándar Internacional',
      descripcion: 'Entrega internacional estándar',
      precio: 'Q 100.00',
